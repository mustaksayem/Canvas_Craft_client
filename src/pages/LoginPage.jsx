...
const LoginPage = () => {
  ...
  const { user, signInWithEmailPassword, googleSignIn, githubSignIn, setLoading, loading } = useAuth();
            ...
            <div className=" w-full  bg-white p-5 rounded-lg lg:rounded-l-none">
              <div className=" p-5 ">
                ...
                <form onSubmit={handleLogin} className="space-y-3 w-full ">
                  ...
                  <button className="px-3 py-2 bg-[#23BE0A] hover:bg-[#23BE0A] rounded text-white font-semibold w-full">
                    Sign In
                  </button>
                  </div>
                </form>
                <div className="flex items-center flex-wrap md:flex-nowrap gap-4 mb-4">
                  <button
                    ...
                    className="w-full max-w-md font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-6"
                  >
                ...
                <div className="">
        <div className="flex justify-center items-center">
          <Link className="px-3 ml-3 py-2 bg-[#23BE0A] hover:bg-[#23BE0A] rounded text-white font-semibold" to="/registration">
            Sign Up
          </Link>
