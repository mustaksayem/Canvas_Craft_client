...
<div className="flex flex-col  p-3  gap-3   overflow-hidden shadow-lg bg-white rounded-2xl  mt-10 ">
        ...
        <div className=" ">
          <div>
           ...
           <div><p className="font-semibold text-xl text-[#131313CC]">Price: {p.price}</p></div>
           <div> <p className="font-semibold text-xl text-[#131313CC]">Rating: {p. rating}</p></div>
           </div>
          <div className="">
          <div><p className="font-semibold text-xl text-[#131313CC] text-center ">Customization: {p. customization}</p></div>
           <div> <p className="font-semibold text-xl text-[#131313CC] text-center">Stock Status: {p. stockStatus}</p></div>
          </div>
          
          <div className="flex  gap-6 justify-center">
            <div><Link to={`/update/${p._id}`}> <a className="btn text-[#FFFFFF] text-lg font-semibold bg-[#59C6D2]">Update</a></Link>
           </div>
            <div><button onClick={() => handleDelete(p._id)}  className="btn text-[#FFFFFF] text-lg font-semibold bg-red-700">Delete</button></div>
          </div>
        </div>
      </div>
